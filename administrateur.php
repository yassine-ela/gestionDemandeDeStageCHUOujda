  ...
  <nav>
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <a href="demandeurAccepter.php" class="btn btn-info btn-lg">Liste des acceptees</a>
                <a href="demandeurRefuser.php" class="btn btn-danger btn-lg">Liste des refusees</a>
                <a href="demandeurSansReponse.php" class="btn btn-info btn-lg">Liste des demandeurs sans reponse</a>

                <h1>Liste De tout les demandeurs de stage </h1>
    <br/>
    <table class="table">
        <thead>
            <th>id</th>
        ...
        <tbody>
            ...
            $req=$db->query('select id,categorie,nom,prenom,specialite,typestage,email,tel,name,file_url,etat from demandeur');
