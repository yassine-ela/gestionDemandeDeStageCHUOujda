...
<html lang="en">
  ...
  <nav>
    ...
    <div class="c1">
            <form action="demandeurIdentification.php" class="  mx-5 p-5  " method="POST" enctype="multipart/form-data"  >
            <div class="mb-3">
        ...
        <div class="p-3 md-5">
            <button class="btn btn-secondary" type="submit" name="confirmer" > <b>Soumettre</b> </button>
        </div>
</form>
    </div>
