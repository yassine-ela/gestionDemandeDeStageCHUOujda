...
<html lang="en">
  <head>
    <title>Demandeurs sans réponse</title>
  ...
  <nav>
            ...
            <div class="text-center">
                ...
                <h1>Liste Des demandeurs sans reponse </h1>
    <br/>
        ...
        <tbody>
            ...
            <td>  
            <a href="reponseForm.php?numDemandeur=<?= $data['id']?>" class="btn btn-info"> Repondre </a>
             </td>
